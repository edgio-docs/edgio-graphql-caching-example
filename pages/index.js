...
export default function Home() {
  const meta = {
    ...
    description: 'This open source project demonstrates GraphQL caching on the Layer0 platform using the SpaceX GraphQL API.',
  ...
  return (
    <>
      ...
      <main className="flex flex-col">
        ...
        <div className="mt-5">
          This open source project demonstrates <ExternalLink href="https://docs.layer0.co/guides/graphql">GraphQL caching</ExternalLink> on the
          Layer0 platform using the <ExternalLink href="https://api.spacex.land/graphql/">SpaceX GraphQL API</ExternalLink>.{' '}
        </div>
        ...
        <div className="mt-10 text-center">
          ...
          <ExternalLink href="https://github.com/layer0-docs/graphql-caching-example/blob/main/routes.js">Github repo</ExternalLink> and more details
          are available in the <ExternalLink href="https://docs.layer0.co/guides/graphql">GraphQL caching guide</ExternalLink>.
        </div>
      </main>
    </>
  )
